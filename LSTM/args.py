...
def multi_task_args_parser():
    ...
    parser.add_argument('--epochs', type=int, default=50, help='input dimension')
    parser.add_argument('--input_size', type=int, default=2, help='input dimension')  # default=3
    parser.add_argument('--seq_len', type=int, default=242, help='seq len')  # default = 24
    parser.add_argument('--output_size', type=int, default=5, help='output dimension')  # default = 12
    parser.add_argument('--hidden_size', type=int, default=64, help='hidden size')
    parser.add_argument('--num_layers', type=int, default=1, help='num layers')
    parser.add_argument('--lr', type=float, default=0.008, help='learning rate')
    parser.add_argument('--batch_size', type=int, default=30, help='batch size')
    ...
    parser.add_argument('--weight_decay', type=float, default=1e-4, help='weight decay')
    parser.add_argument('--bidirectional', type=bool, default=False, help='LSTM direction')
    parser.add_argument('--step_size', type=int, default=3, help='step size')  # default = 5
    parser.add_argument('--n_outputs', type=int, default=2, help='n_outputs')  # default = 3
    parser.add_argument('--pred_step_size', type=int, default=5, help='pred step size')  # default = 12
    parser.add_argument('--gamma', type=float, default=0.5, help='gamma')
